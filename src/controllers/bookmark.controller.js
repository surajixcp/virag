 ...
 * @param {Object} res - Express response object.
  ...
  create: async (req, res, next) => {
    try {
      ...
      data.is_active = true;
      if (!data.user_id) { // TODO: data.user_id is changed req.userId
      ...
      const doesExist = await Model.findOne({ user_id: mongoose.Types.ObjectId(data.user_id), post_id: mongoose.Types.ObjectId(data.post_id) });
